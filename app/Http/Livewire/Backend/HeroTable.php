...
class HeroTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('Image'))
                ->sortable(),
            Column::make(__('Sub Image'))
                ->sortable(),
            Column::make(__('Highlight 1'))
                ->sortable(),
            Column::make(__('Highlight 2'))
                ->sortable(),
            Column::make(__('Highlight 3'))
                ->sortable(),
            Column::make(__('Button Link 1')),
            Column::make(__('Button Link 2')),
            Column::make(__('Page')),
    ...
    {
        return 'livewire.backend.sections.hero.includes.row';
    }
}
