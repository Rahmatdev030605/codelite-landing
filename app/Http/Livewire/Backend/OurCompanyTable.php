...
class OurCompanyTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('Heading'))
                ->sortable(),
            Column::make(__('Sub_Heading'))
                ->sortable(),
            Column::make(__('Description'))
                ->sortable(),
            Column::make(__('Image'))
                ->sortable(),
            Column::make(__('Button_link')),
            Column::make(__('Page')),
    ...
    {
        return 'livewire.backend.sections.our-company.includes.row';
    }
}
