...
namespace App\Domains\Logic\Listeners;

use App\Domains\Logic\Events\User\UserCreated;
use App\Domains\Logic\Events\User\UserDeleted;
use App\Domains\Logic\Events\User\UserDestroyed;
use App\Domains\Logic\Events\User\UserLoggedIn;
use App\Domains\Logic\Events\User\UserRestored;
use App\Domains\Logic\Events\User\UserStatusChanged;
use App\Domains\Logic\Events\User\UserUpdated;
...
class UserEventListener
{
    ...
    public function subscribe($events)
    {
        $events->listen(
            UserLoggedIn::class,
            'App\Domains\Logic\Listeners\UserEventListener@onLoggedIn'
        );

        $events->listen(
            PasswordReset::class,
            'App\Domains\Logic\Listeners\UserEventListener@onPasswordReset'
        );

        $events->listen(
            UserCreated::class,
            'App\Domains\Logic\Listeners\UserEventListener@onCreated'
        );

        $events->listen(
            UserUpdated::class,
            'App\Domains\Logic\Listeners\UserEventListener@onUpdated'
        );

        $events->listen(
            UserDeleted::class,
            'App\Domains\Logic\Listeners\UserEventListener@onDeleted'
        );

        $events->listen(
            UserRestored::class,
            'App\Domains\Logic\Listeners\UserEventListener@onRestored'
        );

        $events->listen(
            UserDestroyed::class,
            'App\Domains\Logic\Listeners\UserEventListener@onDestroyed'
        );

        $events->listen(
            UserStatusChanged::class,
            'App\Domains\Logic\Listeners\UserEventListener@onStatusChanged'
        );
    }
}
