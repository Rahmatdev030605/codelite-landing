...
class FeaturedProductSection extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('featured_product_section', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('featured_product_section');
    }
}
