                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            <td class="text-center">
                                                <div class="avatar avatar-md"><img class="avatar-img" src="asset/img/avatars/1.jpg" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                                            </td>
                                            <td>
                          ...
                          <td>
                            <div class=" small text-medium-emphasis">Last login
                            </div>
