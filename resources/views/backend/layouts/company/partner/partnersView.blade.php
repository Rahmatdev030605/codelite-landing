...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title mt-2"><strong>Partners</strong></h3>
    </div>
                        ...
                        <div class="card-body">
                            <div class="partner-grid mx-auto">
                                ...
                                <div class="blog-head mb-2">
                                    <h6 class="blog-category">Partner Data</h6>
                                </div>
                                <div class="btn-group">
                                    <a href="{{ route('admin.partners') }}" type="button" class="btn btn-info">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="partner-grid mx-auto">
                                ...
                                <div class="blog-head mb-2">
                                    <h6 class="blog-category">Partner List</h6>
                                </div>
                                <div class="btn-group">
