...
<div class="col-md-16">
    ...
    <div class="card-header d-flex justify-content-between">
            <h3 class="card-video"><strong>PROJECTS</strong></h3>
            <a href="{{ route('admin.new-project-section') }}" class="btn btn-success" style="color: white; width: 10%;">New +</a>
        </div>
        ...
        <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="table-responsive">
                                <form action="{{ route('admin.show-project-section') }}" method="GET">
                        ...
                        <div class="col-md-6">
                            <form id="filterForm" action="{{ route('admin.show-project-section') }}" method="GET" class="filter">
                                @csrf
                        ...
                        <table class="table table-transparent table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $project->sub_heading }}</td>
                                    <td style="font-size: 12px;">{{ $project->created_at }}</td>
                                    <td style="font-size: 12px;">{{ $project->updated_at }}</td>
                                    <td style="text-align: center;">
                                        <span class="{{ $project->status == 'active' ? 'text-success' : 'text-danger' }}" style="font-size: 14px">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.edit-project-section', ['id' => $project->id]) }}" class=" btn-sm edit-btn btn-primary btn-animate">
                                            <i class="cil-pencil"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <button class="btn-sm btn-danger delete-btn" data-partner-id="{{ $project->id }}" data-toggle="modal" data-target="#deleteContent{{ $project->id }}">
                                            <i class="cil-trash"></i>
                                        </button>
                                    </td>
                                </tr>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div style="font-size: 13px">
                    <p>Total: {{ $totalProject }} data</p>
                </div>
            </div>


            @foreach($projects as $project)
            <div class="modal fade" id="deleteContent{{ $project->id }}" tabindex="-1" aria-labelledby="deleteContentModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-m">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <form id="content-delete" method="POST" action="{{ route('admin.delete-project-section', $project->id) }}">
                                @csrf
                                @method('DELETE')
                                <p>Are you sure you want to delete <strong id="partner-name">{{ $project->heading }}</strong>?</p>
