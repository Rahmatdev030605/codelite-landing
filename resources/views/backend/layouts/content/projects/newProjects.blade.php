...
<div class="col-md-16">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-video">NEW LEADERSHIP</h3>
        </div>
        ...
        <div class="col-md-12 mt-4">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.store-project-section') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_heading" class="form-control" value="" >
                        </div>
                        <div class="form-group">
