...
<div class="col-md-16">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-video">NEW OUR TRUE WORD</h3>
        </div>
        ...
        <div class="col-md-12 mt-4">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.store-our-true') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc_1" class="form-control" ></textarea>
                        </div>
                        <div class="form-group">
                            <label for="desc">Description Second</label>
                            <textarea name="desc_2" class="form-control" ></textarea>
                        </div>
                        <div class="form-group">
