...
<div class="col-md-16">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-video">EDIT OUR TRUE WORD</h3>
        </div>
        ...
        <div class="col-md-12 mt-4">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.update-our-true', ['id'=> $our->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div id="image-view-pages">
                                <img id="imagePages" src="{{ asset($our->image) }}" alt="gagal">
                            </div>
                        ...
                        <div class="form-group">
                            <label for="desc">Description First</label>
                            <textarea name="desc_1" class="form-control">{{ $our->desc_1 }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="desc">Description Second</label>
                            <textarea name="desc_2" class="form-control">{{ $our->desc_2 }}</textarea>
                        </div>
                        <div class="form-group">
