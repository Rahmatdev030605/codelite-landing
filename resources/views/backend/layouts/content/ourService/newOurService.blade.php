<!-- backend/layouts/content/our-service/new-our-service.blade.php -->
...
<div class="col-md-16">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-video">New Our Services</h3>
        </div>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="form-group">
                            ...
                            <textarea wire:model="description_second" class="form-control"></textarea>
                            @error('description_second') <span class="error">{{ $message }}</span> @enderror
                        </div>
