    ...
    <div class="card card-primary">
        ...
        <div class="col-md-12 mt-4">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.update-our-company', ['id'=> $our->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div id="image-view-pages">
                                <img id="imagePages" src="{{ asset($our->image) }}" alt="image not found">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc" class="form-control">{{ $our->desc }}</textarea>
                        </div>
                        <div class="form-group">
