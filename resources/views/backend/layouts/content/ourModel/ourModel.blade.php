...
<div class="col-md-16">
    ...
    <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{ route('admin.new-our-model') }}" class="btn btn-success" style="color: white; width: 10%;">New +</a>
        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <div class="table-responsive">
                                <form action="{{ route('admin.show-our-model') }}" method="GET">
                        ...
                        <div class="col-md-6">
                            <form id="filterForm" action="{{ route('admin.show-our-model') }}" method="GET" class="filter">
                                @csrf
                        ...
                        <table class="table table-transparent table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.edit-our-model', ['id' => $our->id]) }}" class=" btn-sm edit-btn btn-primary btn-animate">
                ...
                <div class="modal-dialog modal-m">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <form id="content-delete" method="POST" action="{{ route('admin.delete-our-model', $our->id) }}">
                                @csrf
                                @method('DELETE')
