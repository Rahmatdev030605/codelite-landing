...
<section class="news-area">
  <div class="custom-container">
    <div class="section-header d-flex align-items-end justify-content-between">
      ...
      <p>In today's rapidly evolving world, technology is constantly shaping the way we live and interact. From
        artificial intelligence and automation to virtual reality, the pace of technological advancements is
        staggering.</p>
    </div>
    ...
    <div class="sticky-news d-flex card-h">
      ...
      <div class="news-content">
        ...
        <h1 class="section-title">
          <a href="{{ route('frontend.blogDetail')}}">OpenAI launches new alignment division to tackle risks of superintelligent
            AI</a>
        </h1>
    ...
    <div class="news-items d-flex align-items-start">
      ...
      <div class="news-item card-h">
        ...
        <div class="news-item-body">
          ...
          <h1 class="section-title">
            <a href="{{ route('frontend.blogDetail')}}">Bluebase launches Tap to Pay on smartphone for international and domestic
              business</a>
          </h1>
          <p>Small UK merchants, businesses, and other enterprises can now use Tap to Pay on service to replace
            payment terminals at point of sale.</p>
      ...
      <div class="news-item card-h">
        ...
        <div class="news-item-body">
          ...
          <h1 class="section-title">
            <a href="{{ route('frontend.blogDetail')}}">Google Bard launches in EU, overcoming data privacy concerns in the
              region</a>
          </h1>
          <p>Small UK merchants, businesses, and other enterprises can now use Tap to Pay on service to replace
            payment terminals at point of sale.</p>
