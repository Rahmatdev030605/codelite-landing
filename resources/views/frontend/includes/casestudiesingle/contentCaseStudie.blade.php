        ...
        <div class="blog-details-body">
            <div class="blog-details-inner">
                ...
                <div class="blog-details-introduction">
                    ...
                    <img src="{{ mix('img/imgs/case-studie-details-2.jpg') }}" alt="case studies details" />
                    ...
                    <blockquote>
                        ...
                        <div class="blockquote-author-box d-flex align-items-center">
                            <img src="{{ mix('img/imgs/testimonial-1.jpg') }}" alt="Testimonial" />
                            <div class="content">
                                <h3>Serana Belluci</h3>
                                <span>Product Designer</span>
                            </div>
                        </div>
                        <i class="quote-icon las la-quote-right"></i>
                    </blockquote>
                    ...
                    <img src="{{ mix('img/imgs/case-studie-details-3.jpg') }}" alt="Case studies details" />
