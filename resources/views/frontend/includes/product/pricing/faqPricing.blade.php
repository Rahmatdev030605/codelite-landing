<section class="faq-area faq-style-2-area">
    <div class="custom-container">
        <div class="faq-inner">
            ...
            <div id="accordion" class="faq-items-box">
                <div class="faq-col">
                    <div class="faq-box">
                        <h5 class="card-header" id="headingOne">
                            <button data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <div class="icon">
                                    <img src="{{ mix('img/imgs/question-icon.svg') }}" alt="Icon" />
                ...
                <div class="faq-col">
                    <div class="faq-box">
                        <h5 class="card-header" id="headingFour">
                            <button data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                <div class="icon">
                                    <img src="{{ mix('img/imgs/question-icon.svg') }}" alt="Icon" />
