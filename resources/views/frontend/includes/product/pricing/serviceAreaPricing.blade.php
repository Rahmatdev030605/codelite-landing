<section class="service-area service-black-area">
    <div class="custom-container">
        ...
        <div class="services-list">
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-1.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">Development</a></h3>
                <p>Our development is pixel perfect in all ways.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-2.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">Woo Commerce</a></h3>
                <p>We have a best team for your shopping websites.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-3.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">CRM Solutions</a></h3>
                <p>We enhance customer experiences for success.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-4.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">Web Design</a></h3>
                <p>We create vibrant, intuitive and minimalist web</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-6.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">Hardware Services</a></h3>
                <p>We offers expert assistance
                    for your IT issues.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/hwd-icon-4.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">Cloud Services</a></h3>
                <p>we can provide all around
                    the world.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-7.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">Network Security</a></h3>
                <p>We have a best team for your shopping websites.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-8.svg') }}" alt="Service Icon" class="service-icon" />
                <h3><a href="#">Monitoring</a></h3>
                <p>We enhance customer
                    experiences for success.</p>
            </div>
            <div class="service-card simple-shadow">
                <img src="{{ mix('img/imgs/service-icon-9.svg') }}" alt="Service Icon" class="service-icon" />
            ...
            <div class="service-card simple-shadow">
                ...
                <img src="{{ mix('img/imgs/service-icon-5.svg') }}" alt="Service Icon" class="service-icon" />
