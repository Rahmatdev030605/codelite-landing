<section class="our-team-2-area our-team-3-area">
    <div class="custom-container">
        <div class="our-team-inner">
            <img src="{{('img/imgs/bg-shape-mentors.svg')}}" alt="Shape" class="animation-slide-left bg-shape" />

            <div class="section-header our-team-2-header d-flex align-items-center justify-content-between w-full">
                <!-- <img class="bg-shape" src="./assets/imgs/bg-shape-10.svg" alt="Shape" /> -->
                <div class="left">
                    <h5 class="section-subtitle">MENTORS</h5>
                    <h1 class="section-title">Our leadership and mentors</h1>
                    <p>Our team is a collective force of top talents, experts, and
                        visionaries from diverse fields.</p>
                </div>

                <a href="#" class="theme-btn">Meet our experts now</a>
            </div>

            <div class="our-team-2-lists our-team-3-lists">
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team4.png')}}" alt="Team" />
                    </div>
                ...
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team5.png')}}" alt="Team" />
                    </div>
                ...
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team6.png')}}" alt="Team" />
                    </div>
                    <h2>Beatrix Clara</h2>
                ...
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team7.png')}}" alt="Team" />
                    </div>
                ...
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team8.png')}}" alt="Team" />
                    </div>
                    <h2>Aminul Ashfaq</h2>
                ...
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team9.png')}}" alt="Team" />
                    </div>
                ...
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team10.png')}}" alt="Team" />
                    </div>
                ...
                <div class="our-team-2-card">
                    <div class="img-box">
                        <img src="{{('img/imgs/team11.png')}}" alt="Team" />
                    </div>
                    <h2>Emily Frida</h2>
