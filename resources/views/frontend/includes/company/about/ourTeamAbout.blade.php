    ...
    <div class="custom-container">
        ...
        <div class="our-team-2-lists">
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team4.png') }}" alt="Team" />
                </div>
            ...
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team5.png') }}" alt="Team" />
                </div>
            ...
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team6.png') }}" alt="Team" />
                </div>
                <h2>Beatrix Clara</h2>
            ...
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team7.png') }}" alt="Team" />
                </div>
            ...
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team8.png') }}" alt="Team" />
                </div>
                <h2>Aminul Ashfaq</h2>
            ...
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team9.png') }}" alt="Team" />
                </div>
            ...
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team10.png') }}" alt="Team" />
                </div>
            ...
            <div class="our-team-2-card">
                <div class="img-box">
                    <img src="{{ mix('img/imgs/team11.png') }}" alt="Team" />
                </div>
                <h2>Emily Frida</h2>
